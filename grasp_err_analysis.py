...
for t in range(80):
    ...
    with viewer.launch_passive(env._base_env.physics.model.ptr, env._base_env.physics.data.ptr) as v:
        mujoco.mj_step(env._base_env.physics.model.ptr, env._base_env.physics.data.ptr)
        v.sync()
        breakpoint()
