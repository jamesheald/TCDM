...
which pip
cd ~/TCDM/outputs/"$1"
python3 -u /nfs/nhome/live/jheald/TCDM/train.py hydra.run.dir=. # agent=OBJEX_ppo agent.standard_PPO=True agent.controlled_variables=ObjCvelForce

rm -rf /tmp/.bashrc


# e.g. call as sbatch slurm_script.sh '2025-05-13/18-57-50'