...
from tcdm.rl.models.OBJEX.common_type_aliases import RolloutBufferSamples
...
class RolloutBuffer(BaseBuffer):
    ...
    def __init__(
        ...
        self.gamma = gamma
        self.observations, self.actions, self.next_observations, self.rewards, self.advantages = None, None, None, None, None
