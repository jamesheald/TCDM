...
from tcdm.rl.models.OBJEX.distributions import FullGaussianDistribution, make_proba_distribution
...
class ActorCriticPolicy(BasePolicy):
    ...
    def forward(self, obs: th.Tensor, synergies: th.Tensor, deterministic: bool = False) -> Tuple[th.Tensor, th.Tensor, th.Tensor]:
        ...
        distribution = self._get_action_dist_from_latent(latent_pi, synergies, latent_sde=latent_sde)
    ...
    def _get_action_dist_from_latent(self, latent_pi: th.Tensor, synergies: th.Tensor, latent_sde: Optional[th.Tensor] = None) -> Distribution:
        """
    ...
    def _predict(self, observation: th.Tensor, synergies: th.Tensor, deterministic: bool = False) -> th.Tensor:
        """
        Get the action according to the policy for a given observation.
        ...
        distribution = self._get_action_dist_from_latent(latent_pi, synergies, latent_sde)
        return distribution.get_actions(deterministic=deterministic)

    def evaluate_actions(self, obs: th.Tensor, actions: th.Tensor, synergies: th.Tensor,) -> Tuple[th.Tensor, th.Tensor, th.Tensor]:
        """
