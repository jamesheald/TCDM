...
from tcdm.rl.models.OBJEX  import common_policies as policies
...
from tcdm.rl.models.OBJEX.distributions import make_proba_distribution, \
                                                   get_action_dim
# from stable_baselines3.common.distributions import make_proba_distribution, get_action_dim
...
class ActorCriticPolicy(policies.ActorCriticPolicy):
    ...
    def __init__(
        ...
        # Action distribution
        if isinstance(self.log_std_init, list):
            assert isinstance(action_space, gym.spaces.Box), "Only works with box action spaces"
            assert not use_sde, "Not implemented for SDE yet"
