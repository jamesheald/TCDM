...
class MlpExtractor(nn.Module):
    ...
    def __init__(
        ...
        last_layer_dim_ex = feature_dim

        # Build the non-shared part of the network
        for pi_layer_size, vf_layer_size, ex_layer_size in zip_longest(policy_only_layers, value_only_layers, layer["ex"]):
        ...
        self.latent_dim_ex = last_layer_dim_ex
        ...
        self.explore_net = nn.Sequential(*explore_net).to(device)
    ...
    def forward(self, features: th.Tensor) -> Tuple[th.Tensor, th.Tensor]:
        ...
        return self.policy_net(shared_latent), self.value_net(shared_latent), self.explore_net(features)
